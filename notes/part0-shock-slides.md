...
- **對你的承諾**：不懂程式碼，也能獨立產出一個**能跑、能玩、能發布**的作品（頁 9 就是規格）
- **本書案例走到哪**：同一套方法，作者一路做到多人連線落地——但那是**很後面**的事，第 19 頁會講為什麼不能一開始就碰
...
<div class="lead">五個階段衝出第一個可玩版本，前後六個日曆日，然後就沒有停下來過。</div>
...
| **8/30** | 第一個完整版 | <b>六個日曆日、49 份變更說明</b>，多人連線落地 |
| **至今** | 仍在疊代 | 累計 <b>74 份</b>，架構重構、卡片擴充持續進行 |
...
- 衝刺期**平均每天 8 份變更說明**（最多的一天 14 份，最少的一天 2 份），每次只攻克一個小主題
- <span class="highlight">而且到現在都還在跑</span>——這不是一個做完就收工的專案
...
| 記憶複雜的終端機 Git 指令 | 願意守住三條底線鐵律（頁 17 會一條一條給你） |