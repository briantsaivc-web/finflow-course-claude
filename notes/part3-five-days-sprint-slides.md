...
| 五個階段 | 核心任務 | 造物者的把關重點 |
| :--- | :--- | :--- |
| **第一天** | 核心閉環 | 骰子、移動、薪資、破產判定跑得通 |
| **第二天** | 資料注入 | 擴充 20 張職業與基礎機會卡 |
| **第三天** | 機制深化 | 引入三級記帳制與財務分錄 |
| **第四天** | 體驗重構 | 介面拋光、排查通知與跑版 |
| **第五天** | 數值收斂 | 千局模擬測試、平衡性收口 |

- 節奏勝於速度，每一步都踏在可驗證的程式碼基線上
- 這五個階段涵蓋 <b>S1～S20b</b>、共 49 份變更說明；實際交付是<span class="highlight">交錯進行</span>的，逐日流水帳見頁 74
