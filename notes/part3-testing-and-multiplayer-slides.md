...
<div class="lead">前面講的都在這張表裡。<b>一個起點＋六個步驟</b>，接下來要展開的是 Step4。</div>

| | 步驟 | 前面在哪裡講過 |
| :--- | :--- | :--- |
| **起點** | **Step0** 寫鐵律與 MVP 清單 | 第一部（頁 17、21） |
| ① | **Step1** 先要規格書，你審核 | 第二部（頁 41） |
| ② | **Step2** 拿到程式先玩過 | 階段一～四（頁 60–66） |
| ③ | **Step3** 小步快跑疊代 | 頁 73–85 |
| ④ | **Step4** 找人測試 | <span class="highlight">接下來四頁</span> |
| — | **選修** 多人連線 | 頁 90–92 |
| ⑤ | **Step5** 專案管理不出事 | 頁 93–101 |
| ⑥ | **Step6** 判斷能不能分享 | 頁 102 起 |

- 「起點」不算一步，所以是<b>六個步驟</b>；多人連線是選修，不佔編號
- 這張表在頁 105 會再出現一次，那時是回顧
...
- 玩家還看到滿螢幕看不懂的英文代碼 `NO_CAPACITY`。後來也改了：<span class="highlight">錯誤訊息要說人話</span>——「信用額度不足，借不到這個金額」
- 那一局總共回報 5 件事，下一頁會看到：<b>其實只有 3 個問題</b>
...
<div class="lead">使用者告訴你的是<b>症狀</b>，不是病因。分辨病因是你的工作。</div>

| 他們回報的 | 實際上 |
| :--- | :--- |
| 「玩到一半卡住了」 | ← |
| 「某個人的可借金額怪怪的」 | ← 這三個其實出自<b>同一個原因</b> |
| 「合資邀請有問題」 | ← |
| 「借款拉桿拉不到滿」 | 第 2 個問題（獨立） |
| 「商城在別人回合也能買」 | 第 3 個問題（獨立） |

- <b>5 筆回報 ≠ 5 個 bug</b>。不要照回報的條數去修，<span class="highlight">先問「這幾件事會不會是同一件事？」</span>
...
<div class="grid">
  ...
  <div class="arrow">➔</div>
  <div class="box blue">
    <strong>③ 照四欄寫下來</strong><br>
    哪個畫面／按了什麼／<br>以為會怎樣／實際怎樣<br>
    <i>再丟給 AI</i>
  </div>
</div>
...
- 多人連線是整個專案裡<b>最花時間、技術最複雜</b>的一塊。<span class="highlight">不需要卻做了，等於自找兩週的麻煩</span>
- FinFlow 需要，因為它的教育場景就是「一家人各自拿平板一起玩」

---

<!-- 第 91 頁 -->
# 大改動之前：先寫一份放大版規格書，核可才動工

<div class="lead">「凡事豫則立，不豫則廢。」——《中庸》</div>

FinFlow 的多人連線規格書（改動大的時候會寫得更細，所以另外叫它<b>工程書</b>），標題就寫著<b>「草案，待核可後動工」</b>。裡面有三段特別值得抄：

<div class="grid">
  <div class="box blue">
    <strong>你拍板的事</strong><br>
    用哪種連線方案、幾個人、<br>斷線怎麼辦<br>
    <i>這三項，先寫清楚</i>
  </div>
  <div class="box">
...
<div class="grid">
  ...
  <div class="box blue">
    ...
    同一份紀錄、<b>同一組隨機規則</b><br>
    <i>骰子點數順序也一模一樣，<br>算出來保證相同</i>
  </div>
  <div class="arrow">➔</div>
  <div class="box red">
