...
<div class="lead">整本書講的東西收斂成這五句——而且每一句都住在全景圖的某一格。</div>
...
- 這一條是<span class="highlight">做到第 26 版才學會的</span>——前五條寫得出來，是因為它們一開始就用得上；第六條要撞到牆才用得上
...
- 另外兩張要印下來貼牆上的：<b>全景流程圖</b>與<b>工具對照表</b>，都在<span class="highlight">第七部</span>
...
- 如果那個東西<b>不是遊戲</b>——第七部有一張全景圖，把這整套流程換成別的領域，一格都不用改
