...
<div class="lead">整本書最常用的基本功，收斂成這五句——而且每一句都住在全景圖的某一格。</div>
...
- 這一條是<span class="highlight">作者把 FinFlow 做到第 26 版才學會的</span>——前五條寫得出來，是因為它們一開始就用得上；第六條要撞到牆才用得上
...
- 這本書的案例到現在跑了 74 次疊代，而且還在跑；你完成的是第 1 次。**底層流程相通**——差別在專案長大之後，會再長出新的驗證與分工（第六條心法就是第 26 版才學會的）
