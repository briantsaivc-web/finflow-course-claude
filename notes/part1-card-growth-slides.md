...
- **核心原則**：不要試圖在第 1 輪把卡片規則寫到極致[cite: 2]
...
- **初學者心法**：第一版不要管通膨、空租或修繕，跑順規則最優先[cite: 2]
...
| 玩家狀態條件 | 實際承擔與結果 | 遊戲機制教你的事[cite: 2] |
| :--- | :--- | :--- |
| **高現金儲備** | 利率一般，每月穩定收租 +8,000 元 | 現金多是談判籌碼[cite: 2] |
| **高負債槓桿** | 銀行信用調降，利息支出增加 3,000 元 | 負債會侵蝕實質報酬[cite: 2] |
| **已持有修繕手藝** | 自行維護免請師傅，每房每月再省工錢 | 技能可以直接折現[cite: 1] |

- 同一份資料卡片，因為玩家狀態不同而產生策略分歧[cite: 2]
...
<div class="grid">
  <div class="box">
    ...
    表面投報率 8%<br>
    <i>看起來是一門好生意</i>[cite: 2]
  </div>
  <div class="arrow">➔</div>
  <div class="box red">
    <strong>解鎖「財務分析」技能</strong><br>
    看穿未來 5 輪隱性支出<br>
    <i>惡意欠租率 30%・管線老化修繕</i>[cite: 2]
  </div>
</div>

- 讓玩家主動想進修技能，而不是被動堆疊數值[cite: 2]
...
<div class="grid">
  <div class="box red">
    ...
    該商圈屬於人口外移區<br>
    <i>第 10 輪後資產面臨跌價腰斬</i>[cite: 2]
  </div>
  <div class="arrow">➔</div>
  <div class="box blue">
    <strong>高階合規/治理技能</strong><br>
    提前發出週期預警提示<br>
    <i>避開長尾資產歸零風險</i>[cite: 1, 2]
  </div>
</div>

- 商業遊戲的深度，在於將真實世界的「認知落差」做成機制[cite: 2]
...
- **不用一次到位**：這四層是玩過多輪測試後才逐步疊上去的[cite: 2]
- **以問題驅動升級**：玩家被騙過一次，才會懂得在遊戲裡學法律與審計[cite: 1, 2]
- <span class="highlight">造物者鐵律</span>：機制負責製造痛點，技能負責提供解方[cite: 2]
...
<div class="grid">
  <div class="box blue">
    ...
    只做 6 張卡，驗證金流迴圈與勝負結算[cite: 2]
  </div>
  <div class="arrow">➔</div>
  <div class="box">
    <strong>第二步：大量填入內容 (20%)</strong><br>
    機制驗證無誤後，指揮 AI 批量擴充 100 張卡[cite: 2]
  </div>
</div>

- **致命錯誤**：一開始就寫滿 300 張卡片，改一次規則全盤作廢[cite: 2]
...
| 失敗者的思考迴圈 | 造物者的實戰節奏 |
| :--- | :--- |
| 一定要把全台灣所有稅制都塞進去 | 先抓出最常見的薪資與買賣情境[cite: 2] |
| 畫面一定要畫得跟 3A 大作一樣精緻 | 簡單方框與表格能跑就先測[cite: 2] |
| 必須支援八人即時語音連線 | 先做單人對決電腦，把規則測乾淨[cite: 2] |

- **座右銘**：完成遠勝於完美，先求上線、再求豐富[cite: 2]
...
- [ ] **一句話痛點**：你要為玩家提供什麼生活財務的練習場？[cite: 2]
- [ ] **三條底線鐵律**：列出絕對不准 AI 擅自妥協的原則[cite: 2]
- [ ] **MVP 刀法**：挑出 6 張核心卡片與 1 個勝利條件[cite: 2]
